...
const ExaminationPanel = ({ tutorId }) => {
  ...
  const canSubmitMarks = hasActiveExam && allStudentsMarked && !saving;
            ...
            <>
              ...
              <div style={styles.actions}>
                <button
                  ...
                  style={{
                    ...styles.saveButton,
                    ...(!canSubmitMarks ? styles.disabledButton : {}),
                  }}
                  onClick={handleSave}
                  disabled={!canSubmitMarks}
                  title={!hasActiveExam ? 'Select an exam first to submit marks' : !allStudentsMarked ? 'Enter marks for all students before submitting' : ''}
                >
